...
<div id="right-parent" class="p-5 lg:w-full lg:mt-0 bg-white">
  ...
  <form action="<?php echo e(route('stock.dai3.order.search', [], false), false); ?>" method="get">
    ...
    <div class="block w-full mb-2.5">
      <div class="block float-left w-3/10">ご注文日：<input class="border border-solid border-gray-700 p-2px w-1/4 m-5px mr-0" type="date" name="ordered_at[]" placeholder="開始日" value="<?php echo e($params['ordered_at'][0], false); ?>"> から <input class="border border-solid border-gray-700 p-2px w-1/4 m-5px mr-0" type="date" name="ordered_at[]" placeholder="終了日" value="<?php echo e($params['ordered_at'][1], false); ?>"> まで</div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="order_id" placeholder="注文ID" value="<?php echo e($params['order_id'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="search_name" placeholder="注文者名・納品先名・ヨミガナ" value="<?php echo e($params['search_name'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="tel" name="search_tel" placeholder="TEL・納品先TEL" value="<?php echo e($params['search_tel'], false); ?>"></div>
      ...
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="search_address" placeholder="納品先住所" value="<?php echo e($params['search_address'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="item_model" placeholder="型番" value="<?php echo e($params['item_model'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="note" placeholder="備考" value="<?php echo e($params['note'], false); ?>"></div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nagamura/works/sites/mt-d.mitaden.local/resources/views/stock/dai3/order-search.blade.php ENDPATH**/ ?>