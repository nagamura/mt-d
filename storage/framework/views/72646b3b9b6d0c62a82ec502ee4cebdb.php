...
<div id="right-parent" class="p-5 lg:w-full lg:mt-0 bg-white">
  ...
  <form action="<?php echo e(route('stock.dai3.search', [], false), false); ?>" method="GET">
	...
	<li class="leading-7"><label for="s5"><input type="checkbox" name="shop_mall_id[3]" value="s_yahoo_setsubicom" id="s5" <?php echo e(isset($params['shop_mall_id'][3]) ? 'checked="checked"' : '', false); ?>>セツビコム Yahoo!本店</label></li>
      </ul>
    </div>
    <div class="block float-left w-3/10 mr-12 mb-4">
	...
	<li class="leading-7"><label for="e1"><input type="checkbox" name="shop_mall_id[4]" value="e_main_e-setsubibiz" id="e1" <?php echo e(isset($params['shop_mall_id'][4]) ? 'checked="checked"' : '', false); ?>>イーセツビ 本店</label></li>
	<li class="leading-7"><label for="e2"><input type="checkbox" name="shop_mall_id[5]" value="e_rakuten_e-setsubi" id="e2" <?php echo e(isset($params['shop_mall_id'][5]) ? 'checked="checked"' : '', false); ?>>イーセツビ 楽天市場</label></li>
	<li class="leading-7"><label for="e3"><input type="checkbox" name="shop_mall_id[6]" value="e_yahoo_e-setsubi" id="e3" <?php echo e(isset($params['shop_mall_id'][6]) ? 'checked="checked"' : '', false); ?>>イーセツビ Yahoo!本店</label></li>
      </ul>
    </div>
    <div class="block float-left w-3/10 mr-12 mb-4">
	...
	<li class="leading-7"><label for="k1"><input type="checkbox" name="shop_mall_id[7]" value="k_main_tokyo-airconnet" id="k1" <?php echo e(isset($params['shop_mall_id'][7]) ? 'checked="checked"' : '', false); ?>>空調センター 本店</label></li>
	<li class="leading-7"><label for="k2"><input type="checkbox" name="shop_mall_id[8]" value="k_rakuten_tokyo-aircon" id="k2" <?php echo e(isset($params['shop_mall_id'][8]) ? 'checked="checked"' : '', false); ?>>空調センター 楽天市場</label></li>
	<li class="leading-7"><label for="k3"><input type="checkbox" name="shop_mall_id[9]" value="k_yahoo_tokyo-aircon" id="k3" <?php echo e(isset($params['shop_mall_id'][9]) ? 'checked="checked"' : '', false); ?>>空調センター Yahoo!本店</label></li>
      </ul>
    </div>
    <div class="clear-both"></div>
    <div class="block w-full mb-2.5">
      <div class="block float-left w-3/10">ご注文日：<input class="border border-solid border-gray-700 p-2px w-1/4 m-5px mr-0" type="date" name="ordered_at[0]" placeholder="開始日" value="<?php echo e(isset($params['ordered_at'][0]) ? $params['ordered_at'][0]  : '', false); ?>"> から <input class="border border-solid border-gray-700 p-2px w-1/4 m-5px mr-0" type="date" name="ordered_at[1]" placeholder="終了日" value="<?php echo e(isset($params['ordered_at']) ? $params['ordered_at'][1] : '', false); ?>"> まで</div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="order_id" placeholder="注文ID" value="<?php echo e(isset($params['order_id']) ? $params['order_id'] : '', false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="name" placeholder="注文者名・納品先名・ヨミガナ" value="<?php echo e($params['name'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="tel" name="tel" placeholder="TEL・納品先TEL" value="<?php echo e($params['tel'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="email" placeholder="MAIL" value="<?php echo e($params['email'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="address" placeholder="納品先住所" value="<?php echo e($params['address'], false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="item_model" placeholder="型番" value="<?php echo e(isset($params['item_model']) ?  $params['item_model'] : '', false); ?>"></div>
      <div class="block float-left w-3/10"><input class="border border-solid border-gray-700 py-1 px-1 mr-1 mb-2 w-9/10" type="text" name="note" placeholder="備考" value="<?php echo e(isset($params['note']) ? $params['note'] : '', false); ?>"></div>
	...
	<a href="<?php echo e(route('stock.dai3.search', [], false), false); ?>">クリアする</a>
      </div>
    </div>
  </form>
  ...
  <table class="text-sm w-full">
	...
	<td class="py-[15px] px-[10px] whitespace-nowrap">〒<?php echo e(Helper::splitZip($order->zip), false); ?><br>
	...
	<td class="p-0 py-[15px] px-[10px]" colspan="5">
		...
		?>
		<?php if($items->item_count > App\Consts\ShoppingMallOrders::MIN_UNIT_QTY): ?>
		<tr>
		  <td></td>
		  <td class="text-sm text-right">合計</td>
		  <td class="text-sm text-right"><?php echo e($order->getItems()->item_total_unit, false); ?></td>
		  <td class="text-sm text-right"><?php echo e(number_format($order->getItems()->item_total_price), false); ?>円</td>
		</tr>
		<?php endif; ?>
		<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<tr>
    		  <td class="text-sm py-[15px] px-[10px]"><i class="fa fa-caret-right" aria-hidden="true"></i><?php echo e($item->item_name, false); ?></td>
    		  <td class="text-sm w-100 py-[15px] px-[10px] whitespace-nowrap"><?php echo e($item->item_model, false); ?></td>
    		  <td class="text-sm w-50 text-right py-[15px] px-[10px] whitespace-nowrap"><?php echo e($item->item_unit, false); ?></td>
    		  <td class="text-sm w-100 text-regit py-[15px] px-[10px] whitespace-nowrap"><?php echo e(number_format($item->item_price), false); ?>円</td>
    		</tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nagamura/works/sites/mt-d.mitaden.local/resources/views/stock/dai3/search.blade.php ENDPATH**/ ?>